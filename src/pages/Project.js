...
const Project = () => {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                const response = await fetch('http://localhost:9004/api/project/getProjects');
                if (!response.ok) {
    ...
    const handleAddProject = async () => {
        try {
            ...
            const response = await fetch('http://localhost:9004/api/project/CreateProjects', {
                method: 'POST',
                headers: {
    ...
    const handleDeleteProject = async (projectId) => {
        try {
            const response = await fetch(`http://localhost:9004/api/project/DeleteProject/${projectId}`, {
                method: 'DELETE',
            });
   ...
   const handleStatusChange = async (projectId, status) => {
    try {
        const response = await fetch(`http://localhost:9004/api/project/projects/${projectId}/status`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
